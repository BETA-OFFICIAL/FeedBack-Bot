...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "Hai👋, You Can Send Your Feedback Here. Our Owner Will Respond As He Get Time!")
REPLY_TO_THIS_MESSAGE = os.getenv("REPLY_TO_THIS_MESSAGE", "REPLY_TO_THIS")
WRONG_REPLY = os.getenv("WRONG_REPLY", "❌️WRONG_REPLY")
